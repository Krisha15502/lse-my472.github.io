...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = "figure.mw-default-size.mw-halign-left figcaption")
...
```{r}
label_elements_feynman <- html_feynman %>% html_elements(css = "table.infobox.biography.vcard > tbody > tr > th.infobox-label")
data_elements_feynman <- html_feynman %>% html_elements(css = "#mw-content-text > div.mw-content-ltr.mw-parser-output > table.infobox.biography.vcard > tbody > tr > td.infobox-data")
```
